...
const form = ref({
    ...
    password: props.additional.user.password,
    permissions: []
})
const formError = ref({})
            ...
            <section>
                <div class="w-full">
                    ...
                    <VInput placeholder="Insert Name" label="Username" :required="true" v-model="form.name"
                        :errorMessage="formError.name" @update:modelValue="formError.name = ''" class=""/>

                    <VInput placeholder="Insert Email" label="Email" :required="true" v-model="form.email"
                        :errorMessage="formError.email" @update:modelValue="formError.email = ''" class=""/>
                    ...
                    <VInput placeholder="Insert Password" label="Password" :required="true" v-model="form.password"
                        :errorMessage="formError.password" @update:modelValue="formError.password = ''" class=""/>
